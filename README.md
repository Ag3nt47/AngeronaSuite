...
<sub>*Fresh 1920×1040 capture of the current 63-module layout. It is generated by `tools/capture_public_dashboard.py` from fixed synthetic events and resource values; no host telemetry, identity, path, PID, or network address is displayed.*</sub>
