...
<sub>*Fresh 1920×1040 synthetic public-demo capture. It is generated by `tools/capture_public_dashboard.py` from fixed synthetic events and resource values; no host telemetry, identity, path, PID, or network address is displayed. Current discovery finds 71 modules.*</sub>
...
## Current v1.10.3 — Cycle 23 state-grade-pattern defenses
