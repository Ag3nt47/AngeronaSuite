...
## Backup (external, before anything was touched)
`<backup-folder>\streamline-20260702\`
...
## Done
- **Legacy `Angerona/` removed** from the original working location. It was already superseded by `src/angerona/shark/` and was preserved in the external backup.
...
- `.env` (gitignored, holds API keys), all real source, `diagnostics/`, `rules.yar`, `frz/`, `hermetic/`, `syscall_bridge/`.
